...
public class VirtustreamBlobStoreCapabilities extends AbstractCapabilities<Virtustream> implements BlobStoreCapabilities {
    ...
    public VirtustreamBlobStoreCapabilities(Virtustream provider) {
        super(provider);
    }
